...
export const eidAlFitrPosts: Post[] = [
  {
    ...
    translations: {
      fr: "Qu'Allah accepte de nous et de vous. Que chaque année vous trouve en bonne santé.",
      id: 'Semoga Allah menerima amal kami dan Anda. Semoga Anda selalu dalam kebaikan setiap tahun.',
      ms: 'Semoga Allah menerima amalan kami dan anda. Semoga anda sentiasa dalam kebaikan setiap tahun.',
      th: 'ขออัลลอฮฺทรงตอบรับจากเราและจากท่าน ขอให้ท่านมีสุขทุกปี',
      ur: 'اللہ ہم سے اور آپ سے قبول فرمائے۔ ہر سال آپ خیریت سے رہیں۔',
    },
    theme: 'emerald-night',
    decoration: 'lights',
    font: 'aref-ruqaa',
  ...
  },
  {
    ...
    translations: {
      fr: 'Un joyeux Aïd, une longue vie, et des jours faits de joie et de fête.',
      id: 'Selamat Idulfitri, umur yang panjang, dan hari-hari yang penuh suka cita.',
      ms: 'Selamat Aidilfitri, umur yang panjang, dan hari-hari yang penuh kegembiraan.',
      th: 'อีดที่เปี่ยมสุข อายุที่ยืนยาว และวันคืนที่เต็มไปด้วยความยินดี',
      ur: 'عید مبارک، لمبی عمر، اور ایسے دن جو خوشی اور مسرت سے بھرپور ہوں۔',
    },
    theme: 'rose-gold',
    decoration: 'lights',
    font: 'cairo',
